...
//        JFrame window = new JFrame();
        ...
        // Add boardcomponent to window
        window.add(boardComponent);
        // Make window visible
        window.setVisible(true);
        window.repaint();
        // Terminate code on window close
        window.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);

        // Set initial position for each piece, boolean 'w' used to determine piece color
        ...
        // Add class BoardMouseListener to window
